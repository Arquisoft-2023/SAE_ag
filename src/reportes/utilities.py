...
class mapper_repor:
    def to_json(self,item):
        ...
        data = item.__dict__
        if item == "lista":
            data["lista"] = mapper.mapper_to_json_lista(self, item.lista)
        elif item == "observaciones":
            data["observaciones"] = mapper.mapper_to_json_lista(self, item.observaciones)
        elif item == "remisiones":
            data["remisiones"] = mapper.mapper_to_json_lista(self, item.remisiones)
        return data
